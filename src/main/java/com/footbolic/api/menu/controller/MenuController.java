...
public class MenuController {
    ...
    @Operation(summary = "메뉴 목록 조회", description = "메뉴 목록을 트리 형태로 조회한다.")
    ...
    @Operation(summary = "메뉴 생성", description = "파라미터로 전달 받은 메뉴를 생성한다.")
    ...
    @Operation(summary = "메뉴 단건 조회", description = "전달 받은 식별번호를 가진 메뉴를 조회한다.")
    ...
    @Operation(summary = "경로로 메뉴 조회", description = "전달 받은 경로를 가진 메뉴를 조회한다.")
    @Parameter(name = "id", description = "메뉴 식별번호", required = true)
    ...
    @Operation(summary = "메뉴 수정", description = "파라미터로 전달 받은 메뉴를 수정한다.")
    ...
    @Operation(summary = "메뉴 삭제", description = "제공된 식별번호를 가진 메뉴를 삭제한다.")
