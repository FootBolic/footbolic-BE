...
public class AuthorizationController {
    ...
    @GetMapping
    public SuccessResponse getAuthorizationList(Pageable pageable) {
        return new SuccessResponse(authorizationService.findAllAuthorizations(pageable));
    }
    ...
    public ResponseEntity<BaseResponse> getAuthorization(
        ...
        if (id == null || id.isEmpty()) {
            return ResponseEntity.badRequest().body(new ErrorResponse(
                "Provided authorization id is invalid"
            ));
        } else {
            ...
            if (authorization != null) {
                ...
                return ResponseEntity.badRequest().body(new ErrorResponse(
                    "Authorization with provided id does not exist"
                ));
            }
        }
    }
    ...
    public ResponseEntity<BaseResponse> updateAuthorization(
        ...
        if (authorization.getId() == null || authorization.getId().isEmpty()) {
            return ResponseEntity.badRequest().body(new ErrorResponse(
                "Provided authorization id is invalid"
            ));
            ...
            return ResponseEntity.badRequest().body(new ErrorResponse(
                "Provided authorization does not exist"
            ));
        }
    }
